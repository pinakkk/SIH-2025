...
// // Working version before white theme 
// import React, { useState } from "react";
// import { motion } from "framer-motion";
// import { MapPin, ArrowLeft, ImagePlus, Loader2 } from "lucide-react";
// import { BottomNavigation } from "@/components/layout/BottomNavigation";
  ...
  return (
    <div className="min-h-screen font-sans pb-28 bg-gray-50 text-gray-900 dark:bg-[#1f1816] dark:text-white">
      ...
      <motion.header
        initial={{ y: -30, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        className="sticky top-0 z-40 bg-white/70 dark:bg-[#2b2320]/70 backdrop-blur-md border-b border-gray-200 dark:border-[#3a2f2d] px-5 md:px-10 lg:px-16 py-4 flex items-center gap-4"
      >
        <button
          onClick={() => navigate(-1)}
          className="w-10 h-10 rounded-full bg-white text-gray-700 border border-gray-200 dark:bg-[#372a28] dark:text-white dark:border-[#2f2523] flex items-center justify-center hover:scale-105 transition-transform"
        >
          <ArrowLeft size={18} />
        </button>
        <h1 className="font-bold text-lg md:text-xl">Create Post</h1>
      ...
      <div className="px-5 md:px-8 lg:px-12 mt-5">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 }}
            className="bg-white border border-gray-200 dark:bg-[#2b2320]/70 dark:border-[#3a2f2d] rounded-2xl p-4 shadow-sm"
          >
            <textarea
              value={caption}
              onChange={(e) => setCaption(e.target.value)}
              placeholder="Write a caption..."
              rows={4}
              className="w-full bg-transparent outline-none resize-none placeholder-gray-500 dark:placeholder-gray-400 text-sm md:text-base text-gray-900 dark:text-gray-100"
            />
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white border border-gray-200 dark:bg-[#2b2320]/70 dark:border-[#3a2f2d] rounded-2xl p-4 shadow-sm"
          >
            <label className="block text-sm md:text-base text-gray-700 dark:text-gray-300 mb-2">
              Select Hazard Type
            </label>
            <select
              value={hazardType}
              onChange={(e) => setHazardType(e.target.value)}
              className="w-full bg-white border border-gray-200 rounded-xl px-3 py-2 text-sm md:text-base text-gray-900 outline-none dark:bg-[#372a28] dark:text-gray-200 dark:border-[#3a2f2d]"
            >
              <option value="">-- Choose Hazard --</option>
              <option value="Tsunami">🌊 Tsunami</option>
              <option value="Cyclone">🌪️ Cyclone</option>
          ...
          >
            ...
            <label className="cursor-pointer flex items-center justify-center border-2 border-dashed border-gray-200 dark:border-[#3a2f2d] rounded-xl p-6 hover:bg-gray-50 dark:hover:bg-[#3a2f2d]/40 transition">
              <input
                type="file"
                accept="image/*"
                className="hidden"
