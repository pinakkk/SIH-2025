...
User query: ${text}`,
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 dark:bg-gradient-to-b dark:from-[#2a1e1c] dark:to-[#1e1614] text-gray-900 dark:text-white">
      {/* Chat messages area */}
      <div className="flex-1 overflow-y-auto px-3 sm:px-4 pt-20 pb-28 space-y-5 custom-scrollbar max-w-4xl mx-auto w-full">
        {/* Suggested Questions */}
        {!initialLoading && messages.length === 1 && (
          ...
          >
            {suggestedQuestions.map((q, i) => (
              <motion.button
                ...
                onClick={() => handleSend(q)}
                className="p-3 sm:p-4 text-xs sm:text-sm text-left rounded-2xl 
                           bg-gray-100 dark:bg-[#262626] border border-gray-200 dark:border-[#404040] 
                           hover:border-orange-500 hover:text-orange-600 dark:hover:border-[#f57f01] dark:hover:text-[#f57f01] 
          ...
          {messages.map((msg) => {
            ...
            return (
              ...
              >
                {msg.sender === "user" ? (
                  <div className="flex flex-col items-end gap-1 max-w-[90%] sm:max-w-[65%] self-end">
                    <div className="px-3 sm:px-4 py-2 sm:py-3 rounded-2xl rounded-br-sm shadow 
                                    bg-gradient-to-b from-orange-400 to-orange-500 text-black">
                      <div className="text-sm leading-relaxed">
                        <ReactMarkdown remarkPlugins={[remarkGfm]}>
                          {msg.text}
                        </ReactMarkdown>
                  ...
                  <div className="flex flex-col items-start gap-1 max-w-[90%] sm:max-w-[65%]">
                    <div className="flex gap-2 items-end">
                      <img
                        ...
                        className="w-7 h-7 sm:w-8 sm:h-8 rounded-full"
                      />
                      <div className="px-3 sm:px-4 py-2 sm:py-3 rounded-2xl rounded-bl-sm shadow 
                                      bg-gray-100 dark:bg-gradient-to-b dark:from-[#2b2320] dark:to-[#1f1816] 
      ...
      {/* Input area pinned at bottom */}
      <div className="fixed bottom-0 left-0 w-full border-t border-gray-200 dark:border-[#3a2f2d] px-3 sm:px-4 py-2 sm:py-3 bg-white/95 dark:bg-[#1f1816]/95 backdrop-blur-sm">
        <div className="flex items-center gap-2 sm:gap-3 max-w-4xl mx-auto w-full bg-gray-100 dark:bg-[#262626] rounded-full px-2 sm:px-3 py-1 sm:py-2 border border-gray-300 dark:border-[#404040]">
          ...
          <textarea
            ...
            onKeyDown={handleKeyDown}
            placeholder="Type a message..."
            className="flex-1 px-2 sm:px-3 py-2 bg-transparent text-sm text-gray-900 dark:text-white resize-none focus:outline-none min-h-[36px] max-h-28 overflow-y-auto"
            rows={1}
          />
          <motion.button
            onClick={() => handleSend()}
            ...
            className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center transition ${
              !input.trim()
                ? "bg-gray-300 dark:bg-[#404040] text-gray-500 cursor-not-allowed"
                : "bg-gradient-to-b from-orange-400 to-orange-500 text-black shadow-md hover:shadow-lg"
            }`}
          >
            {loading ? (
              <motion.div
