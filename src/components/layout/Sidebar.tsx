...
//   Newspaper,
//   Users,
//   ShieldAlert,   // ✅ better emergency mode icon
// } from "lucide-react";
...
//     { id: "emergency", label: "Emergency Mode", icon: <ShieldAlert size={20} />, route: ROUTES.EMERGENCY_MODE }, // ✅ new icon
//     { id: "evac", label: "Evacuation Centres", icon: <Icon icon="mdi:home-group" className="text-lg" />, route: "/evacuation" },
//     { id: "ai", label: "Get info with our AI", icon: <Icon icon="mdi:robot-outline" className="text-lg" />, route: "/ai" },
//     { id: "help", label: "Help & Support", icon: <HelpCircle size={20} />, route: "/help" },
//     { id: "alerts", label: "Alerts & Notifications", icon: <AlertTriangle size={20} />, route: "/alerts" },
//     { id: "news", label: "News & Updates", icon: <Newspaper size={20} />, route: "/news" },
//   ];
...
//             <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-[#3a2f2d] scrollbar-track-transparent">
//               {/* Header */}
