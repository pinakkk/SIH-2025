      ...
      <div className="w-full max-w-sm text-white backdrop-blur-2xl bg-white/5 border border-white/10 shadow-2xl p-8 rounded-[2rem]">
        ...
        <div className="flex w-full justify-between items-center mb-6">
          <button 
            ...
            className="text-gray-300 p-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition-all"
          >
            <Icon icon="mdi:arrow-left" className="text-lg" />
          </button>
          <h1 className="text-lg font-semibold text-orange-100 drop-shadow-md">Emergency Call</h1>
          <button className="text-gray-300 p-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20">
        ...
        {/* Call Timer Display */}
        <div className="bg-black/20 backdrop-blur-xl border border-white/10 rounded-[2rem] px-6 py-4 mb-6">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-orange-400 font-bold text-lg">+91 112</p>
          <p className="text-gray-400 text-xs">National Emergency Response</p>
        </div>

        {/* Location Status */}
        <div className="bg-green-500/10 backdrop-blur-xl border border-green-500/20 rounded-[2rem] px-4 py-3 mb-8">
          <div className="flex items-center justify-center gap-2">
            <Icon icon="mdi:map-marker" className="text-green-400 text-lg" />
            <span className="text-sm text-green-300">Location shared automatically</span>
          </div>
        </div>
        ...
        <div className="flex justify-center gap-4 mb-8">
          {/* Mute Button */}
          <button className="w-14 h-14 rounded-full bg-black/20 backdrop-blur-xl border border-white/10 flex items-center justify-center hover:bg-white/20 transition-all">
            <Icon icon="mdi:microphone-off" className="text-xl text-gray-300" />
          </button>

          {/* Speaker Button */}
          <button className="w-14 h-14 rounded-full bg-black/20 backdrop-blur-xl border border-white/10 flex items-center justify-center hover:bg-white/20 transition-all">
            <Icon icon="mdi:volume-high" className="text-xl text-gray-300" />
          </button>

          {/* Add Call Button */}
          <button className="w-14 h-14 rounded-full bg-black/20 backdrop-blur-xl border border-white/10 flex items-center justify-center hover:bg-white/20 transition-all">
            <Icon icon="mdi:phone-plus" className="text-xl text-gray-300" />
          </button>
        </div>
