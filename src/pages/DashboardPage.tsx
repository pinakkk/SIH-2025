...
//             className="w-10 h-10 flex items-center justify-center rounded-md bg-[#372a28] hover:bg-[#443331] transition"
//           >
//             <Menu size={22} />
//           </button>
...
//             {isProfileMenuOpen && (
//               <div className="absolute right-0 mt-2 w-40 bg-[#2a2a2a] border border-[#3a2f2d] rounded-lg shadow-lg overflow-hidden z-50">
//                 <button className="w-full text-left px-4 py-2 text-sm hover:bg-[#3a2f2d]">
//                   Profile
//                 </button>
//                 <button className="w-full text-left px-4 py-2 text-sm hover:bg-[#3a2f2d]">
//                   Logout
